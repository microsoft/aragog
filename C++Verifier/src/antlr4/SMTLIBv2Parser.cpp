...
void SMTLIBv2Parser::Qual_identiferContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<SMTLIBv2Listener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterQual_identifer(this);
}

void SMTLIBv2Parser::Qual_identiferContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<SMTLIBv2Listener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitQual_identifer(this);
}
